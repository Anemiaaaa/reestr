...
type Store interface {
	...
	// Sources возвращает источники задачи в порядке загрузки. Общие источники,
	// не привязанные к задаче, сюда не попадают: в задаче участвует вырезанный
	// из них фрагмент, а не сводка целиком.
	...
	// Схема — не факт, а его отображение, и пересобирается целиком.
